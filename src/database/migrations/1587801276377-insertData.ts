...
export class insertData1587801276377 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query('INSERT INTO `user` (`id`,`nick`,`email`,`phone`,`role`,`created_at`,`updated_at`) VALUES ( (SELECT UUID()),\'Ernesto Castillo\',\'ernesstocm@gmail.com\',\'664163653\',\'role_superadmin\',\'2020/04/15 11:58:00.000000\', \'2020/04/15 11:51 8:00.000000\');');
